...
let Tab3Page = class Tab3Page {
    ...
    goToHistoryView(history) {
        const navigationExtras = { state: { history: history } };
    ...
    loadHistory() {
        this.storageService.getHistory().then(historys => {
            if (historys.length !== 0) {
                ...
                this.historyMsgStyle = { 'display': 'none' };
            }
            else {
                this.historys = historys;
                this.historyMsgStyle = { 'display': 'block' };
            }
        });
    }
    loadHistoryClear() {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('myHistoryList', { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], Tab3Page.prototype, "myHistoryList", void 0);
Tab3Page = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_storage_service__WEBPACK_IMPORTED_MODULE_2__["StorageService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]])
], Tab3Page);
