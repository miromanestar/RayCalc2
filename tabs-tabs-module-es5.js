      ...
      children: [{
        ...
        children: [{
          ...
          children: [{
            path: '',
            loadChildren: () => __webpack_require__.e(
            /*! import() | input-page-input-page-module */
            "input-page-input-page-module").then(__webpack_require__.bind(null,
            /*! ../input-page/input-page.module */
            "./src/app/input-page/input-page.module.ts")).then(m => m.InputPagePageModule)
          }]
        }, {
          path: 'results',
          children: [{
            ...
            "./src/app/results/results.module.ts")).then(m => m.ResultsPageModule)
          }]
        }]
      }, {
        path: 'tab2',
        children: [{
          ...
          children: [{
            path: '',
            loadChildren: () => __webpack_require__.e(
            /*! import() | dataview-dataview-module */
            "dataview-dataview-module").then(__webpack_require__.bind(null,
            /*! ../dataview/dataview.module */
            "./src/app/dataview/dataview.module.ts")).then(m => m.DataviewPageModule)
          }]
        }]
      }, {
        path: 'tab3',
        children: [{
          ...
          children: [{
            path: '',
            loadChildren: () => __webpack_require__.e(
            /*! import() | historyview-historyview-module */
            "historyview-historyview-module").then(__webpack_require__.bind(null,
            /*! ../historyview/historyview.module */
            "./src/app/historyview/historyview.module.ts")).then(m => m.HistoryviewPageModule)
          }]
        }]
      }, {
        path: '',
